...
export NUM_CORES=16
export replicate_number=pol1
bash ~/planar_metacmaes/scripts/make.sh

mkdir -p ${RESULTS_DIR}/pol/exp${replicate_number}
${SFERES_DIR}/build/exp/planar_cmaes/planarCMAES_pol_binary ${replicate_number} --d ${RESULTS_DIR}/pol/exp${replicate_number} >> ~/log${replicate_number}.txt
