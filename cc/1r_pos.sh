...
export NUM_CORES=16
export replicate_number=pos1
bash ~/planar_metacmaes/scripts/make.sh

mkdir -p ${RESULTS_DIR}/pos/exp${replicate_number}
${SFERES_DIR}/build/exp/planar_cmaes/planarCMAES_pos_binary ${replicate_number} --d ${RESULTS_DIR}/pos/exp${replicate_number} >> ~/log${replicate_number}.txt
