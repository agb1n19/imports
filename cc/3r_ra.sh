...
export NUM_CORES=16
export replicate_number=ra3
bash ~/planar_metacmaes/scripts/make.sh

mkdir -p ${RESULTS_DIR}/ra/exp${replicate_number}
${SFERES_DIR}/build/exp/planar_cmaes/planarCMAES_ra_binary ${replicate_number} --d ${RESULTS_DIR}/ra/exp${replicate_number} >> ~/log${replicate_number}.txt
