...
bash ~/planar_metacmaes/scripts/train_recovery.sh ~/planar_robo/results pos "damage" a1

export BUILD_TEST=True
export BUILD_TRAIN=False
export BUILD_META=False
bash ~/planar_metacmaes/scripts/make.sh
bash ~/planar_metacmaes/scripts/test_recovery.sh ~/planar_robo/results pos "damage" b1
