...
export NUM_CORES=16
export replicate_number=as1
bash ~/planar_metacmaes/scripts/make.sh

mkdir -p ${RESULTS_DIR}/as/exp${replicate_number}
${SFERES_DIR}/build/exp/planar_cmaes/planarCMAES_as_binary ${replicate_number} --d ${RESULTS_DIR}/as/exp${replicate_number} >> ~/log${replicate_number}.txt
